...
export async function buildSpotsScatterCache({ manifestUrl, img, geneIdColors }) {
  ...
  const { positions, colors, planes, geneIds, neighbours, scores, intensities, filterPairs, scoreMin, scoreMax, intensityMin, intensityMax, hasIntensity } = await call('buildSpotsScatterCache', { manifestUrl, img, geneIdColors });
  return { positions, colors, planes, geneIds, neighbours, scores, intensities, filterPairs, scoreMin, scoreMax, intensityMin, intensityMax, hasIntensity };
}
