...
function setupWidgetControls(elements) {
    ...
    if (elements.cellClassViewerBtn) {
...
// loadAllPlanesForProjection, buildGeoJsonCacheForPlane, extractCellProperties,
// and buildFlattenedProjectionFeatures are imported from src/data/cellProjectionLoader.js
